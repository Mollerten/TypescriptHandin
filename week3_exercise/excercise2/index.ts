...
const createTable = (persons: Person[]): HTMLTableElement => {
...
const toggleSortOrderAsc = (persons: Person[]): void => {
    persons.sort((a, b) => a.age - b.age);
    sortOrder = "asc";

    const table = document.getElementById("personTable") as HTMLTableElement;
    table.remove();
    const rootElement = document.getElementById("root");
    rootElement!.appendChild(createTable(persons));

    const ascButton = document.getElementById("sortAscButton") as HTMLButtonElement;
    const descButton = document.getElementById("sortDescButton") as HTMLButtonElement;
    ascButton.disabled = true;
    descButton.disabled = false;
};

const toggleSortOrderDesc = (persons: Person[]): void => {
...
const attachTable = (persons: Person[]): void => {
